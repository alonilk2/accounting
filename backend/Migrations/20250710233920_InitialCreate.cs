        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsraelTaxId = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    NameHebrew = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    TaxId = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankBranch = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CompanyId1 = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxGenerations = table.Column<int>(type: "int", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CompanyId1 = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryBOMs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InventoryBOMs_Items_ComponentItemId",
                        column: x => x.ComponentItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryBOMs_Items_ParentItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    POSTerminalId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_POSSales_Users_CashierUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesOrders_Agents_AgentId",
                        column: x => x.AgentId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalesOrders_StandingOrders_StandingOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_POSSaleLines_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryBOMs_ComponentItemId",
                table: "InventoryBOMs",
                column: "ComponentItemId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryBOMs_ParentItemId_ComponentItemId",
                table: "InventoryBOMs",
                columns: new[] { "ParentItemId", "ComponentItemId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_CompanyId_ItemId_TransactionDate",
                table: "InventoryTransactions",
                columns: new[] { "CompanyId", "ItemId", "TransactionDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JournalEntries_CompanyId_TransactionDate_AccountId",
                table: "JournalEntries",
                columns: new[] { "CompanyId", "TransactionDate", "AccountId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_POSSales_CompanyId_TransactionNumber",
                table: "POSSales",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrderLines_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrders_StandingOrderId",
                table: "SalesOrders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StandingOrders_CustomerId",
                table: "StandingOrders",
                column: "CustomerId");
