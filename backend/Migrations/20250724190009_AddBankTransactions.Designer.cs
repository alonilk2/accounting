...
namespace backend.Migrations
{
    ...
    [Migration("20250724190009_AddBankTransactions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.AI.AIAssistantConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CurrentDailyUsage")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AIAssistantConfigs", (string)null);
                });
            ...
            modelBuilder.Entity("backend.Models.AI.ChatMessage", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "SessionId", "Timestamp");

                    b.ToTable("ChatMessages", (string)null);
                });

            modelBuilder.Entity("backend.Models.Accounting.BankTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.Purchasing.PurchaseInvoice", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "InternalReferenceNumber")
                        .IsUnique();

                    b.HasIndex("CompanyId", "SupplierInvoiceNumber", "SupplierId")
                        .IsUnique();

                    b.ToTable("PurchaseInvoices", (string)null);
                });

            modelBuilder.Entity("backend.Models.Purchasing.PurchaseInvoiceLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.Purchasing.SupplierPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.Sales.TaxInvoiceReceipt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TaxInvoiceReceipts", (string)null);
                });

            modelBuilder.Entity("backend.Models.Sales.TaxInvoiceReceiptLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TaxInvoiceReceiptId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TaxInvoiceReceiptId");

                    b.ToTable("TaxInvoiceReceiptLines", (string)null);
                });
            ...
            modelBuilder.Entity("backend.Models.Accounting.BankTransaction", b =>
                {
                    b.HasOne("backend.Models.Accounting.ChartOfAccount", "ChartOfAccount")
                        .WithMany()
                    ...
                    b.HasOne("backend.Models.Accounting.JournalEntry", "JournalEntry")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.Sales.TaxInvoiceReceiptLine", b =>
                {
                    ...
                    b.HasOne("backend.Models.Inventory.Item", "Item")
                        .WithMany("TaxInvoiceReceiptLines")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("backend.Models.Sales.TaxInvoiceReceipt", "TaxInvoiceReceipt")
                        .WithMany("Lines")
                        .HasForeignKey("TaxInvoiceReceiptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("TaxInvoiceReceipt");
                });
            ...
            modelBuilder.Entity("backend.Models.Inventory.Item", b =>
                {
                    ...
                    b.Navigation("TaxInvoiceReceiptLines");
                });
