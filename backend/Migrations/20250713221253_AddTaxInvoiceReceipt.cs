...
{
    /// <inheritdoc />
    public partial class AddTaxInvoiceReceipt : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternalReferenceNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaxInvoiceReceipts", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaxInvoiceReceipts_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                name: "TaxInvoiceReceiptLines",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TaxInvoiceReceiptId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaxInvoiceReceiptLines", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaxInvoiceReceiptLines_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaxInvoiceReceiptLines_TaxInvoiceReceipts_TaxInvoiceReceiptId",
                        column: x => x.TaxInvoiceReceiptId,
                        principalTable: "TaxInvoiceReceipts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseInvoiceLines_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseInvoices_CompanyId_InternalReferenceNumber",
                table: "PurchaseInvoices",
                columns: new[] { "CompanyId", "InternalReferenceNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseInvoices_CompanyId_SupplierInvoiceNumber_SupplierId",
                table: "PurchaseInvoices",
                columns: new[] { "CompanyId", "SupplierInvoiceNumber", "SupplierId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierPayments_CompanyId_PaymentNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaxInvoiceReceiptLines_CompanyId",
                table: "TaxInvoiceReceiptLines",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_TaxInvoiceReceiptLines_ItemId",
                table: "TaxInvoiceReceiptLines",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_TaxInvoiceReceiptLines_TaxInvoiceReceiptId",
                table: "TaxInvoiceReceiptLines",
                column: "TaxInvoiceReceiptId");

            migrationBuilder.CreateIndex(
                name: "IX_TaxInvoiceReceipts_CompanyId_DocumentNumber",
                table: "TaxInvoiceReceipts",
                columns: new[] { "CompanyId", "DocumentNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TaxInvoiceReceipts_CustomerId",
                table: "TaxInvoiceReceipts",
                column: "CustomerId");
        }
