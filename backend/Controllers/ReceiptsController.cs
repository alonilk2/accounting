...
public class ReceiptsController : ControllerBase
{
        ...
        string? search = null)
    {
        ...
        if (!string.IsNullOrEmpty(search))
        {
            query = query.Where(r => 
                ...
                (r.Invoice.Customer != null && r.Invoice.Customer.Name.Contains(search)));
        }
    ...
    public async Task<ActionResult<ReceiptDto>> GetReceipt(int id, int companyId)
    {
        ...
        var receiptDto = new ReceiptDto
        {
            ...
            CustomerName = receipt.Invoice.Customer?.Name ?? "N/A",
    ...
    public async Task<ActionResult<ReceiptDto>> CreateReceipt(CreateReceiptDto createReceiptDto, int companyId)
    {
        ...
        var receiptDto = new ReceiptDto
        {
            ...
            CustomerName = createdReceipt.Invoice.Customer?.Name ?? "N/A",
